...
5. If reverse-worded items are part of your scales, check the `$negative_index` element of your object whether the function identified these correctly. If not or to ensure consistency when data changes, manually specify scale keys with the `manual_keys` parameter.
