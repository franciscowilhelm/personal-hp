...
<div id="update-2022" class="section level2">
<h2>Update 2022</h2>
<p>Since the time since I wrote this blog post, a package has been developed that caulcates the multi-level reliability coefficient omega within R. See the function omegaSEM from <a href="http://joshuawiley.com/multilevelTools/reference/omegaSEM.html">multilevelTools</a>.</p>
</div>
<div id="main-post" class="section level2">
<h2>Main post</h2>
...
runModels(target = &quot;multilevel&quot;)</code></pre>
<pre class="r"><code>m_rel_fit &lt;- readModels(target = &quot;multilevel&quot;)</code></pre>
